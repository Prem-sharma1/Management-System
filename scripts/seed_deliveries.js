...
DEL-AID-0037-SM-REELS-3	Janmbhumi Industries	Reel	20-May-2026	Pending	AID-0037-SM-REELS-3		
...
const fs = require('fs');
fs.writeFileSync('C:\\Users\\ADMIN\\.gemini\\antigravity-ide\\brain\\7a021ac8-fe15-4b01-811d-869b72917fa0\\scratch\\raw_deliveries.tsv', rawData.trim());
...
async function seed() {
  ...
  console.log(`Seeding finished. Created ${clientsCreated} clients and ${deliveriesCreated} deliveries.`);
}
